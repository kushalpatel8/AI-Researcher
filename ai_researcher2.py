...
from write_pdf import render_markdown_pdf
from langgraph.prebuilt import ToolNode

# Swap out the old LaTeX tool for the new Markdown tool
tools = [arxiv_search, read_pdf, render_markdown_pdf]
...
model = ChatGoogleGenerativeAI(model="gemini-1.5-flash", api_key=os.getenv("GOOGLE_API_KEY")).bind_tools(tools)
...
# Step5: TESTING
# Updated prompt to explicitly request Markdown formatting
INITIAL_PROMPT = """
...
include mathematical equations in the paper using standard Markdown syntax.
Once it's complete, you should render it as a Markdown PDF using the provided tool. 
Make sure you output the final paper in clean Markdown format. When you give paper 
